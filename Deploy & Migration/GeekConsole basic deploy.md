...
Now you need to reload the sshd service
...
With this particular application, I create a .env example file because I did not want to push the actual .env file to GitHub. So you need to first rename that .envexample:
```bash
mv .envexample .env
...
sudo certbot --nginx -d geekconsole.app -d www.geekconsole.app
